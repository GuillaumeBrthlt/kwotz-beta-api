...
RSpec.describe "/supplier_contacts", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get supplier_contacts_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get supplier_contact_url(supplier_contact), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested supplier_contact" do
        supplier_contact = SupplierContact.create! valid_attributes
        patch supplier_contact_url(supplier_contact),
              params: { supplier_contact: new_attributes }, headers: valid_headers, as: :json
        supplier_contact.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the supplier_contact" do
        supplier_contact = SupplierContact.create! valid_attributes
        patch supplier_contact_url(supplier_contact),
              params: { supplier_contact: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the supplier_contact" do
        supplier_contact = SupplierContact.create! valid_attributes
        patch supplier_contact_url(supplier_contact),
              params: { supplier_contact: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested supplier_contact" do
      supplier_contact = SupplierContact.create! valid_attributes
      expect {
        delete supplier_contact_url(supplier_contact), headers: valid_headers, as: :json
      }.to change(SupplierContact, :count).by(-1)
    end
  end
end
